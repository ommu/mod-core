...
class CoreSettings extends CoreSettingsModel
{
	...
	{
		return [
			[['id', 'site_creation', 'site_dateformat', 'site_timeformat', 'signup_numgiven', 'general_commenthtml', 'banned_ips', 'banned_emails', 'banned_usernames', 'banned_words', 'spam_failedcount', 'license_email', 'license_key', 'ommu_version', 'modified_date', 'modifiedDisplayname'], 'safe'],
	...
	public function search($params, $column=null)
	{
		...
		$query->andFilterWhere(['like', 't.site_dateformat', $this->site_dateformat])
