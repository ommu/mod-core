...
class OmmuLanguages extends OActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('actived, default, creation_id, modified_id', 'numerical', 'integerOnly'=>true),
	...
	public function relations()
	{
		...
		return array(
			'users' => array(self::HAS_MANY, 'Users', 'language_id'),
	...
	public function search()
	{
		...
		if(!Yii::app()->getRequest()->getParam('OmmuLanguages_sort'))
	...
	protected function afterConstruct() {
		if(count($this->templateColumns) == 0) {
			...
			$this->templateColumns['default'] = array(
				'name' => 'default',
				'value' => '$data->default ? CHtml::image(Yii::app()->theme->baseUrl.\'/images/icons/publish.png\') : CHtml::image(Yii::app()->theme->baseUrl.\'/images/icons/unpublish.png\')',
				'htmlOptions' => array(
					'class' => 'center',
				),
				'filter'=>array(
