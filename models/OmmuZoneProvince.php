 ...
 * @property OmmuZoneCity[] $cities
 * @property OmmuZoneCountry $country
 * @property Users $creation
 * @property Users $modified
 */

class OmmuZoneProvince extends OActiveRecord
{
	use GridViewTrait;
	...
	public function relations()
	{
		...
		return array(
			...
			'cities' => array(self::HAS_MANY, 'OmmuZoneCity', 'province_id'),
	...
	public function search()
	{
		...
		$criteria->compare('t.country_id', Yii::app()->getRequest()->getParam('country') ? Yii::app()->getRequest()->getParam('country') : $this->country_id);
		...
		if(!Yii::app()->getRequest()->getParam('OmmuZoneProvince_sort'))
	...
	protected function afterConstruct() {
		if(count($this->templateColumns) == 0) {
			...
			if(!Yii::app()->getRequest()->getParam('country')) {
				$this->templateColumns['country_search'] = array(
					'name' => 'country_search',
					'value' => '$data->country->country_name ? $data->country->country_name : \'-\'',
				);
			}
			...
			if(!Yii::app()->getRequest()->getParam('type')) {
				$this->templateColumns['publish'] = array(
					'name' => 'publish',
					'value' => 'Utility::getPublish(Yii::app()->controller->createUrl(\'publish\', array(\'id\'=>$data->province_id)), $data->publish)',
					'htmlOptions' => array(
						'class' => 'center',
					),
					'filter' => $this->filterYesNo(),
