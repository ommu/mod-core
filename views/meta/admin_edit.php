	...
	<fieldset>
		...
		<?php if($model->meta_image != '') {
			...
			<div class="form-group row">
				<?php echo $form->labelEx($model,'old_meta_image', array('class'=>'col-form-label col-md-3 col-sm-12')); ?>
		...
		<div class="form-group row">
			<?php echo $form->labelEx($model,'meta_image_alt', array('class'=>'col-form-label col-md-3 col-sm-12')); ?>
			<div class="col-md-9 col-sm-12">
