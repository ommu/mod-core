...
<fieldset>
	...
	<div class="form-group row">
		<?php echo $form->labelEx($model,'id', array('class'=>'col-form-label col-lg-4 col-md-3 col-sm-12')); ?>
	...
	<div class="form-group row">
		<?php echo $form->labelEx($model,'office_country_id', array('class'=>'col-form-label col-lg-4 col-md-3 col-sm-12')); ?>
		<div class="col-lg-8 col-md-9 col-sm-12">
	...
	<div class="form-group row">
		<?php echo $form->labelEx($model,'office_province_id', array('class'=>'col-form-label col-lg-4 col-md-3 col-sm-12')); ?>
		<div class="col-lg-8 col-md-9 col-sm-12">
	...
	<div class="form-group row">
		<?php echo $form->labelEx($model,'office_city_id', array('class'=>'col-form-label col-lg-4 col-md-3 col-sm-12')); ?>
		<div class="col-lg-8 col-md-9 col-sm-12">
	...
	<div class="form-group row">
		<?php echo $form->labelEx($model,'office_district', array('class'=>'col-form-label col-lg-4 col-md-3 col-sm-12')); ?>
		<div class="col-lg-8 col-md-9 col-sm-12">
	...
	<div class="form-group row">
		<?php echo $form->labelEx($model,'office_village', array('class'=>'col-form-label col-lg-4 col-md-3 col-sm-12')); ?>
		<div class="col-lg-8 col-md-9 col-sm-12">
	...
	<div class="form-group row">
		<?php echo $form->labelEx($model,'office_hour', array('class'=>'col-form-label col-lg-4 col-md-3 col-sm-12')); ?>
		<div class="col-lg-8 col-md-9 col-sm-12">
	...
	<div class="form-group row">
		<?php echo $form->labelEx($model,'twitter_card', array('class'=>'col-form-label col-lg-4 col-md-3 col-sm-12')); ?>
		<div class="col-lg-8 col-md-9 col-sm-12">
	...
	<div class="form-group row">
		<?php echo $form->labelEx($model,'twitter_photo_width_i', array('class'=>'col-form-label col-lg-4 col-md-3 col-sm-12')); ?>
		<div class="col-lg-8 col-md-9 col-sm-12">
			<?php 
			if(!$model->getErrors())
	...
	<div class="form-group row">
		<?php echo $form->labelEx($model,'facebook_type', array('class'=>'col-form-label col-lg-4 col-md-3 col-sm-12')); ?>
		<div class="col-lg-8 col-md-9 col-sm-12">
