...
<fieldset>
	...
	<div class="form-group row">
		<?php echo $form->labelEx($model,'id', array('class'=>'col-form-label col-md-3 col-sm-12')); ?>
	...
	<div class="form-group row">
		<?php echo $form->labelEx($model,'meta_image', array('class'=>'col-form-label col-md-3 col-sm-12')); ?>
		<div class="col-md-9 col-sm-12">
	...
	<div class="form-group row">
		<?php echo $form->labelEx($model,'office_on', array('class'=>'col-form-label col-md-3 col-sm-12')); ?>
		<div class="col-md-9 col-sm-12">
	...
	<div class="form-group row">
		<?php echo $form->labelEx($model,'office_location', array('class'=>'col-form-label col-md-3 col-sm-12')); ?>
		<div class="col-md-9 col-sm-12">
	...
	<div class="form-group row">
		<?php echo $form->labelEx($model,'office_place', array('class'=>'col-form-label col-md-3 col-sm-12')); ?>
		<div class="col-md-9 col-sm-12">
	...
	<div class="form-group row">
		<?php echo $form->labelEx($model,'office_country_id', array('class'=>'col-form-label col-md-3 col-sm-12')); ?>
		<div class="col-md-9 col-sm-12">
	...
	<div class="form-group row">
		<?php echo $form->labelEx($model,'office_province_id', array('class'=>'col-form-label col-md-3 col-sm-12')); ?>
		<div class="col-md-9 col-sm-12">
	...
	<div class="form-group row">
		<?php echo $form->labelEx($model,'office_city_id', array('class'=>'col-form-label col-md-3 col-sm-12')); ?>
		<div class="col-md-9 col-sm-12">
	...
	<div class="form-group row">
		<?php echo $form->labelEx($model,'office_district', array('class'=>'col-form-label col-md-3 col-sm-12')); ?>
		<div class="col-md-9 col-sm-12">
	...
	<div class="form-group row">
		<?php echo $form->labelEx($model,'office_village', array('class'=>'col-form-label col-md-3 col-sm-12')); ?>
		<div class="col-md-9 col-sm-12">
	...
	<div class="form-group row">
		<?php echo $form->labelEx($model,'office_zipcode', array('class'=>'col-form-label col-md-3 col-sm-12')); ?>
		<div class="col-md-9 col-sm-12">
	...
	<div class="form-group row">
		<?php echo $form->labelEx($model,'office_hour', array('class'=>'col-form-label col-md-3 col-sm-12')); ?>
		<div class="col-md-9 col-sm-12">
	...
	<div class="form-group row">
		<?php echo $form->labelEx($model,'office_email', array('class'=>'col-form-label col-md-3 col-sm-12')); ?>
		<div class="col-md-9 col-sm-12">
	...
	<div class="form-group row">
		<?php echo $form->labelEx($model,'office_hotline', array('class'=>'col-form-label col-md-3 col-sm-12')); ?>
		<div class="col-md-9 col-sm-12">
	...
	<div class="form-group row">
		<?php echo $form->labelEx($model,'office_website', array('class'=>'col-form-label col-md-3 col-sm-12')); ?>
		<div class="col-md-9 col-sm-12">
	...
	<div class="form-group row">
		<?php echo $form->labelEx($model,'google_on', array('class'=>'col-form-label col-md-3 col-sm-12')); ?>
		<div class="col-md-9 col-sm-12">
	...
	<div class="form-group row">
		<?php echo $form->labelEx($model,'twitter_on', array('class'=>'col-form-label col-md-3 col-sm-12')); ?>
		<div class="col-md-9 col-sm-12">
	...
	<div class="form-group row">
		<?php echo $form->labelEx($model,'twitter_card', array('class'=>'col-form-label col-md-3 col-sm-12')); ?>
		<div class="col-md-9 col-sm-12">
	...
	<div class="form-group row">
		<?php echo $form->labelEx($model,'twitter_site', array('class'=>'col-form-label col-md-3 col-sm-12')); ?>
		<div class="col-md-9 col-sm-12">
	...
	<div class="form-group row">
		<?php echo $form->labelEx($model,'twitter_creator', array('class'=>'col-form-label col-md-3 col-sm-12')); ?>
		<div class="col-md-9 col-sm-12">
	...
	<div class="form-group row">
		<?php echo $form->labelEx($model,'twitter_photo_width_i', array('class'=>'col-form-label col-md-3 col-sm-12')); ?>
		<div class="col-md-9 col-sm-12">
			<?php 
			if(!$model->getErrors())
	...
	<div class="form-group row">
		<?php echo $form->labelEx($model,'twitter_photo_height_i', array('class'=>'col-form-label col-md-3 col-sm-12')); ?>
		<div class="col-md-9 col-sm-12">
	...
	<div class="form-group row">
		<?php echo $form->labelEx($model,'twitter_iphone_id', array('class'=>'col-form-label col-md-3 col-sm-12')); ?>
		<div class="col-md-9 col-sm-12">
	...
	<div class="form-group row">
		<?php echo $form->labelEx($model,'twitter_iphone_url', array('class'=>'col-form-label col-md-3 col-sm-12')); ?>
		<div class="col-md-9 col-sm-12">
	...
	<div class="form-group row">
		<?php echo $form->labelEx($model,'twitter_ipad_name', array('class'=>'col-form-label col-md-3 col-sm-12')); ?>
		<div class="col-md-9 col-sm-12">
	...
	<div class="form-group row">
		<?php echo $form->labelEx($model,'twitter_ipad_url', array('class'=>'col-form-label col-md-3 col-sm-12')); ?>
		<div class="col-md-9 col-sm-12">
	...
	<div class="form-group row">
		<?php echo $form->labelEx($model,'twitter_googleplay_id', array('class'=>'col-form-label col-md-3 col-sm-12')); ?>
		<div class="col-md-9 col-sm-12">
	...
	<div class="form-group row">
		<?php echo $form->labelEx($model,'twitter_googleplay_url', array('class'=>'col-form-label col-md-3 col-sm-12')); ?>
		<div class="col-md-9 col-sm-12">
	...
	<div class="form-group row">
		<?php echo $form->labelEx($model,'facebook_on', array('class'=>'col-form-label col-md-3 col-sm-12')); ?>
		<div class="col-md-9 col-sm-12">
	...
	<div class="form-group row">
		<?php echo $form->labelEx($model,'facebook_type', array('class'=>'col-form-label col-md-3 col-sm-12')); ?>
		<div class="col-md-9 col-sm-12">
	...
	<div class="form-group row">
		<?php echo $form->labelEx($model,'facebook_profile_firstname', array('class'=>'col-form-label col-md-3 col-sm-12')); ?>
		<div class="col-md-9 col-sm-12">
	...
	<div class="form-group row">
		<?php echo $form->labelEx($model,'facebook_profile_lastname', array('class'=>'col-form-label col-md-3 col-sm-12')); ?>
		<div class="col-md-9 col-sm-12">
	...
	<div class="form-group row">
		<?php echo $form->labelEx($model,'facebook_profile_username', array('class'=>'col-form-label col-md-3 col-sm-12')); ?>
		<div class="col-md-9 col-sm-12">
