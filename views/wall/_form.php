...
<fieldset>
	...
	<div class="form-group row">
		<?php echo $form->labelEx($model,'wall_media', array('class'=>'col-form-label col-md-3 col-sm-12')); ?>
		<div class="col-md-9 col-sm-12">
	...
	<div class="form-group row">
		<?php echo $form->labelEx($model,'wall_status', array('class'=>'col-form-label col-md-3 col-sm-12')); ?>
		<div class="col-md-9 col-sm-12">
	...
	<div class="form-group row">
		<?php echo $form->labelEx($model,'comments', array('class'=>'col-form-label col-md-3 col-sm-12')); ?>
		<div class="col-md-9 col-sm-12">
	...
	<div class="form-group row">
		<?php echo $form->labelEx($model,'likes', array('class'=>'col-form-label col-md-3 col-sm-12')); ?>
		<div class="col-md-9 col-sm-12">
	...
	<div class="form-group row">
		<?php echo $form->labelEx($model,'creation_date', array('class'=>'col-form-label col-md-3 col-sm-12')); ?>
		<div class="col-md-9 col-sm-12">
	...
	<div class="form-group row">
		<?php echo $form->labelEx($model,'modified_date', array('class'=>'col-form-label col-md-3 col-sm-12')); ?>
		<div class="col-md-9 col-sm-12">
