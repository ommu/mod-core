...
<div class="form" name="post-on">
	...
	<fieldset>
		...
		<div class="form-group row">
			<?php echo $form->labelEx($model,'signup_username', array('class'=>'col-form-label col-lg-4 col-md-3 col-sm-12')); ?>
		...
		<?php if($model->site_type == 1) {?>
		<div class="form-group row">
			<?php echo $form->labelEx($model,'signup_photo', array('class'=>'col-form-label col-lg-4 col-md-3 col-sm-12')); ?>
			<div class="col-lg-8 col-md-9 col-sm-12">
		...
		<?php if($model->site_type == 1) {?>
		<div class="form-group row">
			<?php echo $form->labelEx($model,'signup_approve', array('class'=>'col-form-label col-lg-4 col-md-3 col-sm-12')); ?>
			<div class="col-lg-8 col-md-9 col-sm-12">
		...
		<?php if($model->site_type == 1) {?>
		<div class="form-group row">
			<?php echo $form->labelEx($model,'signup_welcome', array('class'=>'col-form-label col-lg-4 col-md-3 col-sm-12')); ?>
			<div class="col-lg-8 col-md-9 col-sm-12">
		...
		<?php if($model->site_type == 1) {?>
		<div class="form-group row">
			<label class="col-form-label col-lg-4 col-md-3 col-sm-12"><?php echo $model->getAttributeLabel('signup_inviteonly');?> <span class="required">*</span></label>
			<div class="col-lg-8 col-md-9 col-sm-12">
		...
		<?php if($model->site_type == 1) {?>
		<div class="form-group row">
			<?php echo $form->labelEx($model,'signup_invitepage', array('class'=>'col-form-label col-lg-4 col-md-3 col-sm-12')); ?>
			<div class="col-lg-8 col-md-9 col-sm-12">
		...
		<div class="form-group row">
			<?php echo $form->labelEx($model,'signup_verifyemail', array('class'=>'col-form-label col-lg-4 col-md-3 col-sm-12')); ?>
			<div class="col-lg-8 col-md-9 col-sm-12">
		...
		<?php if($model->site_type == 1) {?>
		<div class="form-group row">
			<?php echo $form->labelEx($model,'spam_signup', array('class'=>'col-form-label col-lg-4 col-md-3 col-sm-12')); ?>
			<div class="col-lg-8 col-md-9 col-sm-12">
		...
		<div class="form-group row">
			<?php echo $form->labelEx($model,'signup_random', array('class'=>'col-form-label col-lg-4 col-md-3 col-sm-12')); ?>
			<div class="col-lg-8 col-md-9 col-sm-12">
		...
		<?php if($model->site_type == 1) {?>
		<div class="form-group row">
			<?php echo $form->labelEx($model,'signup_terms', array('class'=>'col-form-label col-lg-4 col-md-3 col-sm-12')); ?>
			<div class="col-lg-8 col-md-9 col-sm-12">
		...
		<div class="form-group row">
			<?php echo $form->labelEx($model,'signup_adminemail', array('class'=>'col-form-label col-lg-4 col-md-3 col-sm-12')); ?>
			<div class="col-lg-8 col-md-9 col-sm-12">
