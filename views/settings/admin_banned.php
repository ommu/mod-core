...
<div class="form" name="post-on">
	...
	<fieldset>
		...
		<div class="form-group row">
			<?php echo $form->labelEx($model,'spam_invite', array('class'=>'col-form-label col-lg-4 col-md-3 col-sm-12')); ?>
			<div class="col-lg-8 col-md-9 col-sm-12">
		...
		<div class="form-group row">
			<label class="col-form-label col-lg-4 col-md-3 col-sm-12"><?php echo $model->getAttributeLabel('spam_login');?> <span class="required">*</span></label>
			<div class="col-lg-8 col-md-9 col-sm-12">
		...
		<div class="form-group row">
			<?php echo $form->labelEx($model,'spam_contact', array('class'=>'col-form-label col-lg-4 col-md-3 col-sm-12')); ?>
			<div class="col-lg-8 col-md-9 col-sm-12">
		...
		<div class="form-group row">
			<?php echo $form->labelEx($model,'spam_comment', array('class'=>'col-form-label col-lg-4 col-md-3 col-sm-12')); ?>
			<div class="col-lg-8 col-md-9 col-sm-12">
