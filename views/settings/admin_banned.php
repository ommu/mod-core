...
<div class="form" name="post-on">
	...
	<fieldset>
		...
		<div class="form-group row">
			<?php echo $form->labelEx($model,'spam_invite', array('class'=>'col-form-label col-md-3 col-sm-12')); ?>
			<div class="col-md-9 col-sm-12">
		...
		<div class="form-group row">
			<label class="col-form-label col-md-3 col-sm-12"><?php echo $model->getAttributeLabel('spam_login');?> <span class="required">*</span></label>
			<div class="col-md-9 col-sm-12">
				...
				<?php echo $form->textField($model,'spam_failedcount', array('class'=>'form-control')); ?>&nbsp;&nbsp;<?php echo Yii::t('phrase', 'failed logins');?>
				<?php echo $form->error($model,'spam_failedcount'); ?>
			</div>
		</div>

		<div class="form-group row">
			<?php echo $form->labelEx($model,'spam_contact', array('class'=>'col-form-label col-md-3 col-sm-12')); ?>
			<div class="col-md-9 col-sm-12">
		...
		<div class="form-group row">
			<?php echo $form->labelEx($model,'spam_comment', array('class'=>'col-form-label col-md-3 col-sm-12')); ?>
			<div class="col-md-9 col-sm-12">
		...
		<div class="form-group row">
			<label class="col-form-label col-md-3 col-sm-12"><?php echo $model->getAttributeLabel('general_commenthtml');?> <span class="required">*</span></label>
			<div class="col-md-9 col-sm-12">
