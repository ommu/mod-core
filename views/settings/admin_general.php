...
<div class="form" name="post-on">
	...
	<fieldset>
		...
		<div id="construction" <?php echo $model->online == '1' ? 'class="hide"' : ''; ?>>
			<div class="form-group row">
				<label class="col-form-label col-lg-3 col-md-3 col-sm-12"><?php echo $model->getAttributeLabel('construction_date');?> <span class="required">*</span></label>
				<div class="col-lg-6 col-md-9 col-sm-12">
					<?php 
			...
			<div id="comingsoon" class="form-group row <?php echo $model->online != '2' ? 'hide' : ''; ?>">
				<label class="col-form-label col-lg-3 col-md-3 col-sm-12"><?php echo $model->getAttributeLabel('construction_text[comingsoon]')?> <span class="required">*</span></label>
				<div class="col-lg-6 col-md-9 col-sm-12">
					<?php 
					if(!$model->getErrors())
			...
			<div id="maintenance" class="form-group row <?php echo $model->online != '0' ? 'hide' : ''; ?>">
				<label class="col-form-label col-lg-3 col-md-3 col-sm-12"><?php echo $model->getAttributeLabel('construction_text[maintenance]')?> <span class="required">*</span></label>
				<div class="col-lg-6 col-md-9 col-sm-12">
		...
		<div class="form-group row">
			<label class="col-form-label col-lg-3 col-md-3 col-sm-12"><?php echo $model->getAttributeLabel('event_i')?> <span class="required">*</span></label>
			<div class="col-lg-6 col-md-9 col-sm-12">
				<?php 
				if(!$model->getErrors()) {
					$model->event_i = 0;
		...
		<div id="events" <?php echo $model->event_i == '0' ? 'class="hide"' : ''; ?>>
			<div class="form-group row">
				<label class="col-form-label col-lg-3 col-md-3 col-sm-12"><?php echo $model->getAttributeLabel('event_startdate');?> <span class="required">*</span></label>
				<div class="col-lg-6 col-md-9 col-sm-12">
					<?php 
					if(!$model->getErrors())
			...
			<div class="form-group row">
				<label class="col-form-label col-lg-3 col-md-3 col-sm-12"><?php echo $model->getAttributeLabel('event_finishdate');?> <span class="required">*</span></label>
				<div class="col-lg-6 col-md-9 col-sm-12">
					<?php 
					if(!$model->getErrors())
			...
			<div class="form-group row">
				<label class="col-form-label col-lg-3 col-md-3 col-sm-12"><?php echo $model->getAttributeLabel('event_tag')?> <span class="required">*</span></label>
				<div class="col-lg-6 col-md-9 col-sm-12">
		...
		<div class="form-group row">
			<label class="col-form-label col-lg-3 col-md-3 col-sm-12"><?php echo $model->getAttributeLabel('site_title');?> <span class="required">*</span></label>
			<div class="col-lg-6 col-md-9 col-sm-12">
		...
		<div class="form-group row">
			<label class="col-form-label col-lg-3 col-md-3 col-sm-12"><?php echo $model->getAttributeLabel('site_url')?> <span class="required">*</span></label>
			<div class="col-lg-6 col-md-9 col-sm-12">
